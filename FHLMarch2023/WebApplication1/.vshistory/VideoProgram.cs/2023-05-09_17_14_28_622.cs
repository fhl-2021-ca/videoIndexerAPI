...
namespace VideoIndexerArm
{
    public static class VideoProgram
    {
        ...
        public static async Task<String> indexvideoAndGetInsights(string VideoUrl)
        {
            ...
            VideoResponse video = response.Videos[0];
            ResponseKeyword transcript = video.Insights.Transcript;
            Sentiment sentiment = video.Insights.Sentiments;
            AudioEffect emotions = video.Insights.Emotions;
