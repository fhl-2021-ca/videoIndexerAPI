...
namespace VideoIndexerArm
{
    public static class VideoProgram
    {
            ...
            if(NegativeSet != null)
            {
                for (int i = 0; i < NegativeSet.Count; i++)
                {
                    ...
                    else
                    {
                        ...
                        createGPTInput2(transcript, transcript2, workingSet.emotions);
                    }
                }
        ...
        private static void createGPTInput2(List<Transcript> transcript, List<Transcript> transcript2, Emotion emotions)
        {
