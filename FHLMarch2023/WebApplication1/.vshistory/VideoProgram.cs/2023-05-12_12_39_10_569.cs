    ...
    public static class VideoProgram
    {
        ...
        public static async Task<List<String>> GetInsights(string videoId)
        {
            ...
            */
            ...
            return GenerateOutputForSentiment(negativeSentiment, finalOutput);
        }

        private static void GenerateOutputForSentiment(Sentiment NegativeSet, List<string> finalOutput)
        {
            if (NegativeSet != null)
            {
