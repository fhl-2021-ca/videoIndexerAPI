...
namespace VideoIndexerArm
{
    public static class VideoProgram
    {
            ...
            if(NegativeSet != null)
            {
                for (int i = 0; i < NegativeSet.Count; i++)
                {
                    ...
                    else
                    {
                        ...
                        conversation = createGPTInput2(transcript, transcript2, workingSet.emotions);
                        finalOutput.Add(getGPTResponse(conversation));
                    }
                }
            }
        ...
        private static string createGPTInput2(List<Transcript> transcript, List<Transcript> transcript2, Emotion emotions)
        {
        ...
        private static string getGPTResponse(String conversation)
        {
