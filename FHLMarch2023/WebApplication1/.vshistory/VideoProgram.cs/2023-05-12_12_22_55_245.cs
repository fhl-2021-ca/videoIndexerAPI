...
namespace VideoIndexerArm
{
    public static class VideoProgram
    {
        ...
        private static void getGPTResponse(String conversation)
        {
            ...
            string prompt = $"Imagine yourself as diversity & inclusion coach. . \n\nFollowing is the chat showing negative sentiments, microaggression by one of the speaker. Walk through this one by one and understand what emotions each speaker is going through and how it affects diversity and inclusion. Conversation is as follows : \n\n{conversation}. \n\nWhat Hema could have said differently to change this negative sentiment to positive from D&I perspective ? "
